        ...
        {categoryByProduct !== null &&
          ...
          categoryByProductIsLoading === false && (
            <View
              ...
              <UI.Div width="95%" mr={'auto'} ml="auto">
                <UI.Flex spaceb>
                  <UI.Div p={4}>
                    <UI.Text
                      cp
                ...
                {/* ************************************All Products********************* */}
                <ScrollView
                  style={{marginBottom: Platform.isPad ? '15%' : '25%'}}
                            ...
                            <UI.Div width={'60%'}>
                              ...
                              <View
                                ...
                                <View
                                  ...
                                  {el.productPrice == null ||
                                  el.productPrice == el.salePrice ||
                                  el.productPrice == 0 ? null : (
                                    <UI.Text
                                      font={fonts.rr}
                                      color={'#22c55e'}
                                      ml={10}
...
const styles = StyleSheet.create({
  ...
  tinyLogo: {
    resizeMode: Platform.isPad ? 'stretch' : 'contain',
    borderRadius: 12,
    width: '100%',
    height: '100%',
  },
